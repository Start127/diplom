...
pip install pytelegrambotapi telebot paramiko 
touch ~/tmp.cron
echo 'source /root/telegram_bot/venvBOT/bin/activate && python3 /root/telegram_bot/venvBOT/bot_v3.10.py' >> ~/.bashrc 
crontab ~/tmp.cron
rm ~/tmp.cron 
# �������� ���������� ������� � crontab
...
if [ -f "/root/telegram_bot/venvBOT/bot_v3.10.py" ]; then
    echo "бот успешно скачан по первой ссылке /root/telegram_bot/venvBOT/bot_v3.10.py для запуска бота выполните python3 /root/telegram_bot/venvBOT/bot_v3.10.py  или перезагрузите пк"
else
    echo "������ ��� ���������� ����. ������� ������� �� ������ ������..."
    # ������ ������� ���������� ����
